...
class AdDataService
{
    ...
    {
        Log::warning('aggregateMetrics: campaigns', ['campaigns' => $campaigns]);
        $totals = [];
        $metricKeys = null;

        foreach ($campaigns as $campaign) {
            Log::warning('aggregateMetrics: campaign', ['campaign' => $campaign]);
            ...
            Log::warning('aggregateMetrics: metricKeys', ['metricKeys' => $metricKeys]);
