...
class AdDataService
{
    ...
    {
        Log::warning('1aggregateMetrics: campaigns', ['campaigns' => $campaigns]);
        $totals = [];
        $metricKeys = null;

        foreach ($campaigns as $campaign) {
            Log::warning('2aggregateMetrics: campaign', ['campaign' => $campaign]);
            ...
            Log::warning('3aggregateMetrics: metricKeys', ['metricKeys' => $metricKeys]);
