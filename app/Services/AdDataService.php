...
class AdDataService
{
     ...
     * Supports: { "data": { "campaigns": [...] } }, { "data": [...] }, or direct array.
     *
     * @param mixed $data
    ...
    protected function extractCampaigns($data): array
    {
        ...
        // API shape: { "data": { "campaigns": [ ... ] } }
        if (isset($data['data']['campaigns']) && is_array($data['data']['campaigns'])) {
            return $data['data']['campaigns'];
        }
        // API shape: { "data": [ ... ] }
        if (isset($data['data']) && is_array($data['data']) && $this->isList($data['data'])) {
            return $data['data'];
        }
        if ($this->isList($data)) {
            return $data;
